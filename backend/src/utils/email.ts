...
export const sendVerificationEmail = async (email: string, token: string, expiresAt?: string) => {
...
export const sendPasswordResetEmail = async (email: string, token: string, expiresAt?: string) => {
